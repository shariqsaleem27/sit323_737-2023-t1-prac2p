...
// Post a new user
// curl -X POST http://localhost:3000/users -H 'Content-Type: application/json' -d '{"id":4,"name":"litt"}'
...
// curl -X PUT http://localhost:3000/users/-id- -H "Content-Type: application/json" -d '{"id":1,"name":"harvey"}'
